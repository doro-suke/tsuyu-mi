# Pythonだけで YouTube 動画を全自動生成するパイプラインを作った話
- **Source URL**: https://zenn.dev/neuvecom/articles/f823265da90b7f
- **Score**: 88
- **Suggested Tags**: #自動化パイプライン, #Gemini, #動画生成
...
音声合成
COEIROINK v2 API（ローカル稼働）


動画合成
MoviePy 2.x + Pillow + NumPy
...
OP/ED の追加 — 動画としての体裁を整える

表情・口パク — キャラの表現力を向上

LINE チャット風の縦動画 — Shorts 向けに全面リデザイン

YouTube/X 投稿の自動化 — 手動作業を削減
...
動画倍速でピッチ上昇
MoviePy の with_speed_scaled()

shorts_skip タグで自然に尺を調整
