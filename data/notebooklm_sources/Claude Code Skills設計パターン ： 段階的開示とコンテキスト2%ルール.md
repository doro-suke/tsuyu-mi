# Claude Code Skills設計パターン ： 段階的開示とコンテキスト2%ルール
- **Source URL**: https://zenn.dev/correlate_dev/articles/claude-code-skills-progressive-disclosure
- **Score**: 88
- **AI Summary**:
...
- **Read Now Reason**: AI駆動開発においてClaude Codeを使用する際、トークン消費を抑えつつエージェントの自律稼働品質を保証するための具体的なディレクトリ構成やIron Law（合理化防止ルール）の記述テンプレートを即座に適用できるため。
- **Suggested Tags**: #Claude-Code, #AI-Driven-Development, #Prompt-Engineering, #Agent-Architecture
